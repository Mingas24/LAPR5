		...
		return (
			<div>
				...
				<div className="title-block">
					<h1 className="title" style={{ color: '#2e2e2e'}}> PAREDES BUS NETWORK </h1>
					<img class="title_image"src="https://icon-library.com/images/bus-icon/bus-icon-23.jpg" alt="BUS"/>	
				</div>
